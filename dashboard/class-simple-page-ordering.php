	...
	class Simple_Page_Ordering
	{
		...
		public static function wp()
		{
			...
			if ((is_string($orderby) && 0 === strpos($orderby, 'menu_order')) || (isset($orderby['menu_order']) && 'ASC' === $orderby['menu_order'])) {
				...
				$script_name       = 'js/simple-page-ordering.js';
				$script_asset_path = plugin_dir_path(__FILE__) . 'js/simple-page-ordering.asset.php';
				...
				if (false !== $script_asset) {
					...
					wp_enqueue_style('simple-page-ordering', plugins_url('/css/simple-page-ordering.css', __FILE__), [], $script_asset['version']);
				} else {
					add_action(
						'admin_notices',
						function () {
